...
public class MinersMultitool extends ItemTool implements ItemModelProvider{
	public static Item repairItem = ModItems.ingotMinersEyengot;
	protected String name;
	public static float attack_speed = -3F;
	public static float base_damage = 10F;
	
	public MinersMultitool(ToolMaterial material, Item repairItem, String name) {
		super(base_damage, attack_speed, material, Collections.EMPTY_SET);
	...
	public void registerItemModel(Item item) {
		MinersEyeMod.proxy.registerItemRenderer(item, 0, name);
	}
